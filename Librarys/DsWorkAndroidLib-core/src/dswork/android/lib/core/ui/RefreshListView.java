...
//
//        mFooterLinearLayout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.refresh_list_header, null);
//        addFooterView(mFooterLinearLayout);
//        mFooterProgressBar = (ProgressBar) findViewById(R.id.refresh_list_header_progressbar);
//        mFooterTextView = (TextView) mFooterLinearLayout.findViewById(R.id.refresh_list_header_text);
